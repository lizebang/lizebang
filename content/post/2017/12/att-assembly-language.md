...
| 寄存器 | $r\_{a}$                     | $R[r\_{a}]$                             | 寄存器寻址        |
| 存储器 | $I\_{mm}$                    | $M[I\_{mm}]$                            | 绝对寻址          |
| 存储器 | $(r\_{a})$                   | $M[R[r\_{a}]]$                          | 间接寻址          |
| 存储器 | $I{mm}(r \_ {b})$            | $M[I\_{mm}+R[r \_ {b}]]$                | (基址+偏移量)寻址 |
| 存储器 | $(r\_{b}, r\_{i})$           | $M[R[r\_{b}]+R[r\_{i}]]$                | 变址寻址          |
| 存储器 | $I\_{mm}(r\_{b}, r\_{i})$    | $M[I\_{mm}+R[r\_{b}]+R[r\_{i}]]$        | 变址寻址          |
| 存储器 | $(, r\_{i}, s)$              | $M[R[r\_{i}] \ast s]$                   | 比例变址寻址      |
| 存储器 | $I\_{mm}(, r\_{i}, s)$       | $M[I\_{mm}+R[r\_{i}] \ast s]$           | 比例变址寻址      |
| 存储器 | $(r\_{b}, r\_{i}, s)$        | $M[R[r\_{b}]+R[r\_{i}] \ast s]$         | 比例变址寻址      |
| 存储器 | $I\_{mm}(r\_{b}, r\_{i}, s)$ | $M[I\_{mm}+R[r\_{b}]+R[r\_{i}] \ast s]$ | 比例变址寻址      |
